  ...
  <div class="panel panel-info">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#<?php echo $row['doc_id'] ?>"><?php echo $row['doc_title'] ?></a>
      </h4>
    </div>
    <div id="<?php echo $row['doc_id'] ?>" class="panel-collapse collapse">
      <div class="panel-body"> <?php echo $row['doc_desc'] ?>

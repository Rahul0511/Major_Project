  ...
  <div class="panel panel-info">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#<?php echo $row['circular_id'] ?>"><?php echo $row['circular_title'] ?></a>
      </h4>
    </div>
    <div id="<?php echo $row['circular_id'] ?>" class="panel-collapse collapse">
      <div class="panel-body"> <?php echo $row['circular_desc'] ?>
